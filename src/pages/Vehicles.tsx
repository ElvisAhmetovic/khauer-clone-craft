      ...
      <div className="bg-orange-500 text-white py-20">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-5xl md:text-6xl font-bold mb-6">
            {t('vehicles.title').split(' ')[0]} <span className="text-white">{t('vehicles.title').split(' ').slice(1).join(' ')}</span>
          </h1>
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden max-w-7xl mx-auto">
            ...
            <div className="p-8 text-center">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 bg-orange-500 hover:bg-orange-600 text-white font-bold py-4 px-8 rounded-lg transition-colors duration-300 text-lg"
              >
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="text-center">
              ...
              <h3 className="font-bold text-lg mb-2 text-orange-500">{t('vehicles.features.quality.title')}</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="font-bold text-lg mb-2 text-blue-500">{t('vehicles.features.service.title')}</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="font-bold text-lg mb-2 text-orange-500">{t('vehicles.features.contact.title')}</h3>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              ...
              className="inline-flex items-center gap-2 bg-orange-500 hover:bg-orange-600 text-white font-bold py-3 px-6 rounded-lg transition-colors duration-300"
            >
            ...
            <a
              ...
              className="inline-flex items-center gap-2 bg-white hover:bg-gray-100 text-blue-500 font-bold py-3 px-6 rounded-lg transition-colors duration-300"
            >
