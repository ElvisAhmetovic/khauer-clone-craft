        ...
        <div className="container mx-auto px-4">
          <div className="bg-white rounded-lg shadow-lg overflow-hidden max-w-7xl mx-auto">
            ...
            <div className="p-8 text-center">
              ...
              <a ref={buttonRef} href="https://www.autoscout24.ch/de/s/seller-68160" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-brand-orange hover:bg-orange-600 text-white font-bold py-4 px-8 rounded-lg transition-colors duration-300 text-lg">
      ...
      <div className="bg-brand-blue text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="tel:+41763367799" className="inline-flex items-center gap-2 bg-brand-orange hover:bg-orange-600 text-white font-bold py-3 px-6 rounded-lg transition-colors duration-300">
              <Phone className="w-5 h-5" />
              {t('vehicles.cta.call')}
            </a>
            <a href="mailto:kurdocar@bluewin.ch" className="inline-flex items-center gap-2 bg-white hover:bg-gray-100 text-brand-blue font-bold py-3 px-6 rounded-lg transition-colors duration-300">
