  ...
  return <div className="min-h-screen">
      ...
      <div className="bg-black text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <button onClick={handleContactClick} className="inline-block bg-orange-400 hover:bg-blue-500 text-black font-bold py-3 px-8 rounded-lg transition-colors duration-300">
