...
const translations = {
  de: {
    ...
    'vehicles.inventory.description': 'Besuchen Sie unsere AutoScout24-Seite für alle aktuellen Fahrzeuge',
    'vehicles.inventory.button': 'Zu unseren Fahrzeugen auf AutoScout24',
  ...
  en: {
    ...
    'vehicles.inventory.description': 'Visit our AutoScout24 page for all current vehicles',
