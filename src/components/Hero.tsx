      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl">
          <h1 className={`text-6xl md:text-8xl font-bold mb-8 leading-tight uppercase tracking-wider transition-all duration-1000 ease-out ${
            ...
            {t('hero.title1')}
            <span className={`block text-orange-500 transition-all duration-1000 ease-out delay-300 ${
              isLoaded 
                ? 'opacity-100 translate-x-0' 
                : 'opacity-0 -translate-x-12'
            }`}>
          ...
          <div className={`mb-12 transition-all duration-1000 ease-out delay-500 ${
            ...
            <Button 
              size="lg" 
              className={`animated-shake-button bg-orange-500 hover:bg-orange-600 text-white font-bold text-lg px-8 py-4 uppercase tracking-wider transition-all duration-300 ${
