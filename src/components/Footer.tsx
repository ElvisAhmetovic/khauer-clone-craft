    ...
    <footer className="bg-black text-white border-t-4 border-orange-500">
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div>
            <h3 className="text-2xl font-bold mb-4 text-orange-500">KURDO Car GmbH</h3>
          ...
          <div>
            <h4 className="text-lg font-semibold mb-4 text-orange-500">{t('footer.services')}</h4>
          ...
          <div>
            <h4 className="text-lg font-semibold mb-4 text-orange-500">{t('footer.contact')}</h4>
      ...
      <div className="border-t border-gray-800 bg-orange-500">
